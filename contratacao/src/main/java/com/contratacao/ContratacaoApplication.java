...
public class ContratacaoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * pessoa2.setSobrenome("Martiniano de Alencar"); pessoa2.setCpf("65611588735");
		 * pessoa2.setDataNascimento(new GregorianCalendar(1829, 05, 01));
		 * 
		 * pessoaService.salva(pessoa2);
		 * 
		 * Pessoa pessoa3 = new Pessoa(); pessoa3.setNome("Antônio");
		 * pessoa3.setSobrenome("Frederico de Castro Alves");
		 * pessoa3.setCpf("77906536444"); pessoa3.setDataNascimento(new
		 * GregorianCalendar(1847, 02, 14));
		 * 
		 * pessoaService.salva(pessoa3);
		 * 
		 * Pessoa pessoa4 = new Pessoa(); pessoa4.setNome("Jorge");
		 * pessoa4.setSobrenome("Leal Amado de Faria"); pessoa4.setCpf("05631565463");
		 ...
		 * 
		 * Pessoa pessoa6 = new Pessoa(); pessoa6.setNome("Aluísio");
		 * pessoa6.setSobrenome("Tancredo Gonçalves de Azevedo");
		 * pessoa6.setCpf("65992536361"); pessoa6.setDataNascimento(new
		 * GregorianCalendar(1857, 03, 14));
		 * 
		 * pessoaService.salva(pessoa6);
		 * 
		 * Pessoa pessoa7 = new Pessoa(); pessoa7.setNome("José");
		 * pessoa7.setSobrenome("Maria de Eça de Queiroz");
		 * pessoa7.setCpf("02833435088"); pessoa7.setDataNascimento(new
		 * GregorianCalendaD(1845, 9, 25));
		 * 
		 * pessoaService.salva(pessoa7);
		 */

		/*
		 * Pessoa pessoa8 = new Pessoa(); pessoa8.setNome("Antônio");
		 * pessoa8.setSobrenome("Gonçalves Dias"); pessoa8.setCpf("13610528990");
		 * pessoa8.setDataNascimento(new GregorianCalendar(1823, 07, 10));
		 * 
		 * pessoaService.salva(pessoa8);
		 * 
		 * Pessoa pessoa9 = new Pessoa(); pessoa9.setNome("Manoel");
		 * pessoa9.setSobrenome("Antônio Álvares de Azevedo");
		 * pessoa9.setCpf("50650964810"); pessoa9.setDataNascimento(new
		 * GregorianCalendar(1831, 8, 31));
		 * 
		 * pessoaService.salva(pessoa9);
		 * 
		 * Pessoa pessoa10 = new Pessoa(); pessoa10.setNome("Joaquim");
		 * pessoa10.setSobrenome("Aurélio Barreto Nabuco de Araújo");
		 * pessoa10.setCpf("27151762283"); pessoa10.setDataNascimento(new
		 * GregorianCalendar(1849, 07, 19));
		 * 
